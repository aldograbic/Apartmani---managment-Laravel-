                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item active" href="<?php echo e(url('/prices_table')); ?>">Tablica cijena</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
...
</html><?php /**PATH C:\Users\Korisnik\OneDrive\Dokumenti\projekti\Apartmani - managment\Apartmani-managment\resources\views/apartments/prices_table.blade.php ENDPATH**/ ?>