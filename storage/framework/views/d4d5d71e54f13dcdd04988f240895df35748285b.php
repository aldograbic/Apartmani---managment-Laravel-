                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo e(url('/users')); ?>">Korisnici</a>
                            </li>
                        </ul>
        ...
        <table class="table text-center position-absolute top-50 start-50 translate-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($user->vat_number); ?></td>
                        <td><?php echo e($user->profile_image); ?></td>
...
<?php /**PATH C:\Users\Korisnik\OneDrive\Dokumenti\projekti\Apartmani - managment\Apartmani-managment\resources\views/users/index.blade.php ENDPATH**/ ?>