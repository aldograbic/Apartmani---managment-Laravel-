...
<body>
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item active" href="<?php echo e(url('/total_made')); ?>">Ukupna zarada</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
    ...
    <main>
        <div class="text-center position-absolute top-50 start-50 translate-middle">
            <p>Ukupno zarađeno:</p>
            <p><?php echo e($total_price); ?> &euro;</p>
        </div>
    </main>
</body>
</html><?php /**PATH C:\Users\Korisnik\OneDrive\Dokumenti\projekti\Apartmani - managment\Apartmani-managment\resources\views/reservations/total_made.blade.php ENDPATH**/ ?>